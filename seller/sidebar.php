...
<div class="col-lg-3 col-md-4 pro" style="background-color: #bac3cd;border-radius:10px;">
   ...
   <div class="d-md-block collapse" id="collapseAccountMenu" style="">
      <ul class="nav flex-column nav-account side-menu">
         <li class="nav-item">
            <a class="nav-link text-dark <?php echo ($current_page == 'seller_dashboard.php') ? 'active' : ''; ?>" href="seller_dashboard.php">
            <span class="ms-2"> <strong>Products List</strong> </span>
            </a>
         </li>
         <li class="nav-item">
            <a class="nav-link text-dark <?php echo ($current_page == 'add-products.php') ? 'active' : ''; ?>" href="add-products.php">
